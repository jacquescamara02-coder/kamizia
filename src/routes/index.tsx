...
const promises: Array<[LucideIcon, string, string]> = [
  [ShieldCheck,"Sélection rigoureuse","Caractéristiques, état et documentation vérifiés selon les éléments disponibles."],
  [FileCheck2,"Devis détaillé","Une proposition adaptée à votre besoin, sans prix inventé pour les commandes spéciales."],
